...
function Footer(){
    return (
      <>
        <div id="contact" className="text-[#d9d9d9] bg-[#323232] flex flex-col gap-[20px] py-[20px] px-[8vh] pt-[80px] mt-[100px]">
          <div className="w-full grid grid-cols-[2fr_1fr_1fr] gap-[80px] ">
            <div className="flex flex-col items-start gap-[20px] ">
              <img src={assets.logo} alt="" />
              <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore
                est temporibus accusantium tempora facilis! Harum, magni.
                Asperiores odio placeat quam!
              </p>
            ...
            <div className="flex flex-col items-start gap-[20px]">
              ...
              <ul className="cursor-pointer">
                ...
                <li className="list-none mb-2">contact@gmail.com</li>
              </ul>
            </div>
          </div>
          <hr className="w-full h-[2px] m-[20px] bg-gray-700 border-none " />
          <p>Copyright 2025 &copy; Tomato</p>
        </div>
      </>
    );
}
